...
%
% Working class: amsart (compiles with any standard TeX Live).
% For final submission to MCOM, change ONLY the first line:
%   \documentclass{amsart}  -->  \documentclass{mcom-l}
% and copy mcom-l.cls into the project folder.
%-----------------------------------------------------------------------
...
\item Permanent Zenodo archive:
      \url{https://doi.org/10.5281/zenodo.19182594}
\end{itemize}
An extended a-file for OEIS A248044 has been submitted.
...
preprint, 2025; data and code: Zenodo
...
\end{document}
%-----------------------------------------------------------------------
% For final submission to MCOM:
%   Change \documentclass{amsart}
%       to \documentclass{mcom-l}
%   and copy mcom-l.cls into the project folder.
%-----------------------------------------------------------------------
