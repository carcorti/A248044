...
\pacs[MSC Classification]{11A41, 11Y55, 11N05, 11A07}

\abstract{We present the first large-scale computational investigation of
...
\subsection{Consecutive-$m$ pairs and the shadowing mechanism}
...
The monolithic program \texttt{sun\_A248044\_v5.c}
...
motivated this work.
The use of AI tools in the development of this work is disclosed
in Section~\ref{sec:ai-disclosure}.
...
\item[Data availability] \label{sec:data}
  ...
  \begin{itemize}
    ...
    \item OEIS: \url{https://oeis.org/A248044}
  \end{itemize}

\item[Code availability]
  The C~source code for the monolithic search
  (\texttt{sun\_A248044\_v5.c}), the segmented targeted search
  (\texttt{sun\_A248044\_targeted\_v3.c}), and a Python
  verification script (\texttt{verify\_A248044.py}) that checks
